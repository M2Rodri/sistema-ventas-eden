...
/**
 * Entidad Oferta - Promociones y descuentos
 */
@Entity
@Table(name = "ofertas")
@Data
...
public class Oferta {
    ...
    // Relación con productos en oferta
    @ManyToMany
    @JoinTable(
    ...
    public Oferta(String descripcion, BigDecimal descuento, LocalDate fechaInicio, LocalDate fechaFin) {
